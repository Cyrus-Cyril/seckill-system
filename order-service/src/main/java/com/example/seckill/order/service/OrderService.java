...
import com.example.seckill.order.client.ProductRemoteClient;
...
public class OrderService {
    ...
    public SeckillSubmitResponse submitSeckillOrder(SeckillOrderRequest request) {
        ...
        ProductSnapshot product = productRemoteClient.getProduct(request.getProductId());
    ...
    public void createPendingOrder(OrderCreateCommand command) {
        ...
        ProductSnapshot product = productRemoteClient.getProduct(command.getProductId());
        if (product == null || product.getStatus() == null || product.getStatus() != 1) {
